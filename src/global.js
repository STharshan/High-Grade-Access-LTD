export const siteConfig = {
  branding: {
    companyName: "High Grade Access LTD",
    logo: "/logo.png",
    logoAlt: "Logo",
    primaryCtaLabel: "Get a Free Quote",
    primaryCtaHref: "mailto:Shay@highgradeaccess.co.uk",
  },
  navigation: {
    links: [
      { label: "Home", href: "" },
  ...
  hero: {
    badge: "High Grade Access LTD Services",
    title: {
  ...
  contact: {
    ...
    address: "9 Bowman Avenue, Warrington, WA4 1SJ, Cheshire",
    socialLinks: [
  ...
  footer: {
    introTitle: "Hello, We Are High Grade Access LTD",
    introDescription:
      "Our experienced team provide the best service.",
    officeTitle: "Office",
    officeLocation: "Cheshire",
    officeEmail: "office.co.uk",
    officePhone: "07758076536",
    linksTitle: "Links",
    socialTitle: "Get In Touch",
    brandName: "High Grade Access LTD",
    copyrightYear: "2026",
